...
#TODO interessierender Faktor mit interessierendem Faktor Level aus modelsplit holen und zu Nullhypothesen machen
#interessierender Faktor
key <- modelsplit[2] 
#Liste an der Stelle des interessierenden Faktors ist Dunnet
mylist <- list()
mylist[[key]] <- "Dunnet"
names(mylist) <- key 
#Dunnet Kontrast Multipler Vergleich der Mittelwerte, Vergleiche nach Dunnet nur nach einer Kontrollgruppe
# glht nimmt lineares Modell, linfct sind Nullhypthesen, test ob erstes Level kleiner als der Rest
output_mcp <- glht(lmfit, linfct = mcp2(mylist), alternative = "less") 
#TODO Tabelle schön darstellen
summary(output_mcp)
confint(output_mcp, level = 0.95) #simultane Konfidenzintervall untere obere Grenze 
#TODO Interpretation der Tabelle anfügen, ob adjustierte p-Werte signifikant für Faktorlevel
# Output Schätzer , Fehler, adjustierte p-Werte, beim einschrittigen Verfahren
