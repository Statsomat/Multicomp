...
#Set factor level of interest as first level of factor of interest
key <- modelsplit[2] 
factorlevel <- modelsplit [3]
levels(df_factorized[,colnames(df_factorized)==key]) <- levels(relevel(df_factorized[,colnames(df_factorized)==key], factorlevel))
